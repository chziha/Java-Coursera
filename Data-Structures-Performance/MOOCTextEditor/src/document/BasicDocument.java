...
public class BasicDocument extends Document {
	...
	/**
	 * Method to get the number of words in the document.
	...
	/**
	 * Method to get the number of sentences in the document.
	...
	/**
	 * Method to get the total number of syllables in the document.  
	 * This method should process the entire text string each time it is called.  
